...
[![Join the chat at https://gitter.im/zgypa/dotfiles](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/zgypa/dotfiles?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)

#### sh -c "\`curl -fsSL https://raw.githubusercontent.com/zgypa/dotfiles/master/install.sh \`"
...
```bash
sh -c "`curl -fsSL https://raw.githubusercontent.com/zgypa/dotfiles/master/install.sh`" -s ask
```
...
* If you want to use an alternate colorscheme like Gruvbox, then in your `~/.vimrc.after` do:
