...
def install_ubuntu_apps
  ...
  # Install other apps
  run %{sudo apt install --yes ncal docker.io docker-compose} 
end
...
def install_homebrew
  ...
  puts "======================================================"
  # Linux and Darwin
  run %{brew install pandoc ctags shellcheck zsh git gh ghi git-flow tmux the_silver_searcher htop task taskwarrior-tui lazygit gpg}
